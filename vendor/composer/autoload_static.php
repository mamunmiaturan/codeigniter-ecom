...
class ComposerStaticInitd751713988987e9331980363e24189ce
{
    ...
    public static $classMap = array (
        'Activity_logs_model' => __DIR__ . '/../..' . '/application/models/Activity_logs_model.php',
        'Admin_Controller' => __DIR__ . '/../..' . '/application/core/MY_Controller.php',
        'Ajax_model' => __DIR__ . '/../..' . '/application/models/Ajax_model.php',
        'Api_Auth_Controller' => __DIR__ . '/../..' . '/application/core/Api_Auth_Controller.php',
        'Api_Controller' => __DIR__ . '/../..' . '/application/core/Api_Controller.php',
        'Api_rate_limiter' => __DIR__ . '/../..' . '/application/libraries/Api_rate_limiter.php',
        'Api_refresh_token_model' => __DIR__ . '/../..' . '/application/models/Api_refresh_token_model.php',
        'Api_token_model' => __DIR__ . '/../..' . '/application/models/Api_token_model.php',
        'App_lib' => __DIR__ . '/../..' . '/application/libraries/App_lib.php',
        'App_model' => __DIR__ . '/../..' . '/application/models/App_model.php',
        'Attribute_family_model' => __DIR__ . '/../..' . '/application/models/Attribute_family_model.php',
        'Attribute_model' => __DIR__ . '/../..' . '/application/models/Attribute_model.php',
        'Audit_chain' => __DIR__ . '/../..' . '/application/libraries/Audit_chain.php',
        'Authentication_Controller' => __DIR__ . '/../..' . '/application/core/MY_Controller.php',
        'Authentication_model' => __DIR__ . '/../..' . '/application/models/Authentication_model.php',
        'Backup_model' => __DIR__ . '/../..' . '/application/models/Backup_model.php',
        'Banner_model' => __DIR__ . '/../..' . '/application/models/Banner_model.php',
        'Base_Model' => __DIR__ . '/../..' . '/application/core/MY_Model.php',
        'Base_Service' => __DIR__ . '/../..' . '/application/core/Base_Service.php',
        'Blog_post_model' => __DIR__ . '/../..' . '/application/models/Blog_post_model.php',
        'Brand_model' => __DIR__ . '/../..' . '/application/models/Brand_model.php',
        'Cart_model' => __DIR__ . '/../..' . '/application/models/Cart_model.php',
        'Cart_rule_model' => __DIR__ . '/../..' . '/application/models/Cart_rule_model.php',
        'Catalog_rule_model' => __DIR__ . '/../..' . '/application/models/Catalog_rule_model.php',
        'Category_model' => __DIR__ . '/../..' . '/application/models/Category_model.php',
        'Cms_page_model' => __DIR__ . '/../..' . '/application/models/Cms_page_model.php',
        'Cod_gateway' => __DIR__ . '/../..' . '/application/libraries/Payment_gateways.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Composite_model' => __DIR__ . '/../..' . '/application/models/Composite_model.php',
        'Contact_message_model' => __DIR__ . '/../..' . '/application/models/Contact_message_model.php',
        'Coupon_model' => __DIR__ . '/../..' . '/application/models/Coupon_model.php',
        'Cron_Controller' => __DIR__ . '/../..' . '/application/core/MY_Controller.php',
        'Customer_address_model' => __DIR__ . '/../..' . '/application/models/Customer_address_model.php',
        'Customer_group_model' => __DIR__ . '/../..' . '/application/models/Customer_group_model.php',
        'Customer_model' => __DIR__ . '/../..' . '/application/models/Customer_model.php',
        'Dashboard_model' => __DIR__ . '/../..' . '/application/models/Dashboard_model.php',
        'Download_model' => __DIR__ . '/../..' . '/application/models/Download_model.php',
        'Email_model' => __DIR__ . '/../..' . '/application/models/Email_model.php',
        'Email_template_model' => __DIR__ . '/../..' . '/application/models/Email_template_model.php',
        'Faq_model' => __DIR__ . '/../..' . '/application/models/Faq_model.php',
        'Flash_sale_model' => __DIR__ . '/../..' . '/application/models/Flash_sale_model.php',
        'Frontend_Controller' => __DIR__ . '/../..' . '/application/core/MY_Controller.php',
        'Import_model' => __DIR__ . '/../..' . '/application/models/Import_model.php',
        'Inventory_model' => __DIR__ . '/../..' . '/application/models/Inventory_model.php',
        'Jwt' => __DIR__ . '/../..' . '/application/libraries/Jwt.php',
        'Landing_model' => __DIR__ . '/../..' . '/application/models/Landing_model.php',
        'Language_model' => __DIR__ . '/../..' . '/application/models/Language_model.php',
        'Login_history_model' => __DIR__ . '/../..' . '/application/models/Login_history_model.php',
        ...
        'MY_Log' => __DIR__ . '/../..' . '/application/core/MY_Log.php',
        'MY_Migration' => __DIR__ . '/../..' . '/application/libraries/MY_Migration.php',
        'MY_Model' => __DIR__ . '/../..' . '/application/core/MY_Model.php',
        'MY_Security' => __DIR__ . '/../..' . '/application/core/MY_Security.php',
        'Migration_model' => __DIR__ . '/../..' . '/application/models/Migration_model.php',
        'Mock_gateway' => __DIR__ . '/../..' . '/application/libraries/Payment_gateways.php',
        'Module_model' => __DIR__ . '/../..' . '/application/models/Module_model.php',
        'Newsletter_model' => __DIR__ . '/../..' . '/application/models/Newsletter_model.php',
        'Notification_model' => __DIR__ . '/../..' . '/application/models/Notification_model.php',
        'Order_model' => __DIR__ . '/../..' . '/application/models/Order_model.php',
        ...
        'Password_history_model' => __DIR__ . '/../..' . '/application/models/Password_history_model.php',
        'Payment_gateway' => __DIR__ . '/../..' . '/application/libraries/Payment_gateways.php',
        ...
        'Product_attribute_value_model' => __DIR__ . '/../..' . '/application/models/Product_attribute_value_model.php',
        'Product_model' => __DIR__ . '/../..' . '/application/models/Product_model.php',
        'Pusher_lib' => __DIR__ . '/../..' . '/application/libraries/Pusher_lib.php',
        'Queue' => __DIR__ . '/../..' . '/application/libraries/Queue.php',
        'Queue_model' => __DIR__ . '/../..' . '/application/models/Queue_model.php',
        'Recaptcha' => __DIR__ . '/../..' . '/application/libraries/Recaptcha.php',
        'Redis_lib' => __DIR__ . '/../..' . '/application/libraries/Redis_lib.php',
        'Report_model' => __DIR__ . '/../..' . '/application/models/Report_model.php',
        'Return_model' => __DIR__ . '/../..' . '/application/models/Return_model.php',
        'Review_model' => __DIR__ . '/../..' . '/application/models/Review_model.php',
        'Role_model' => __DIR__ . '/../..' . '/application/models/Role_model.php',
        'Sales_model' => __DIR__ . '/../..' . '/application/models/Sales_model.php',
        ...
        'Seeder' => __DIR__ . '/../..' . '/application/core/Seeder.php',
        'Settings_model' => __DIR__ . '/../..' . '/application/models/Settings_model.php',
        'Shipping_model' => __DIR__ . '/../..' . '/application/models/Shipping_model.php',
        'Sms_model' => __DIR__ . '/../..' . '/application/models/Sms_model.php',
        'Sslcommerz_gateway' => __DIR__ . '/../..' . '/application/libraries/Payment_gateways.php',
        'Tax_model' => __DIR__ . '/../..' . '/application/models/Tax_model.php',
        ...
        'Totp' => __DIR__ . '/../..' . '/application/libraries/Totp.php',
        'User_2fa_model' => __DIR__ . '/../..' . '/application/models/User_2fa_model.php',
        'User_model' => __DIR__ . '/../..' . '/application/models/User_model.php',
        'Wishlist_model' => __DIR__ . '/../..' . '/application/models/Wishlist_model.php',
    );
