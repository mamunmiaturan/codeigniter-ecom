...
return array(
    'Activity_logs_model' => $baseDir . '/application/models/Activity_logs_model.php',
    'Admin_Controller' => $baseDir . '/application/core/MY_Controller.php',
    'Ajax_model' => $baseDir . '/application/models/Ajax_model.php',
    'Api_Auth_Controller' => $baseDir . '/application/core/Api_Auth_Controller.php',
    'Api_Controller' => $baseDir . '/application/core/Api_Controller.php',
    'Api_rate_limiter' => $baseDir . '/application/libraries/Api_rate_limiter.php',
    'Api_refresh_token_model' => $baseDir . '/application/models/Api_refresh_token_model.php',
    'Api_token_model' => $baseDir . '/application/models/Api_token_model.php',
    'App_lib' => $baseDir . '/application/libraries/App_lib.php',
    'App_model' => $baseDir . '/application/models/App_model.php',
    'Attribute_family_model' => $baseDir . '/application/models/Attribute_family_model.php',
    'Attribute_model' => $baseDir . '/application/models/Attribute_model.php',
    'Audit_chain' => $baseDir . '/application/libraries/Audit_chain.php',
    'Authentication_Controller' => $baseDir . '/application/core/MY_Controller.php',
    'Authentication_model' => $baseDir . '/application/models/Authentication_model.php',
    'Backup_model' => $baseDir . '/application/models/Backup_model.php',
    'Banner_model' => $baseDir . '/application/models/Banner_model.php',
    'Base_Model' => $baseDir . '/application/core/MY_Model.php',
    'Base_Service' => $baseDir . '/application/core/Base_Service.php',
    'Blog_post_model' => $baseDir . '/application/models/Blog_post_model.php',
    'Brand_model' => $baseDir . '/application/models/Brand_model.php',
    'Cart_model' => $baseDir . '/application/models/Cart_model.php',
    'Cart_rule_model' => $baseDir . '/application/models/Cart_rule_model.php',
    'Catalog_rule_model' => $baseDir . '/application/models/Catalog_rule_model.php',
    'Category_model' => $baseDir . '/application/models/Category_model.php',
    'Cms_page_model' => $baseDir . '/application/models/Cms_page_model.php',
    'Cod_gateway' => $baseDir . '/application/libraries/Payment_gateways.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'Composite_model' => $baseDir . '/application/models/Composite_model.php',
    'Contact_message_model' => $baseDir . '/application/models/Contact_message_model.php',
    'Coupon_model' => $baseDir . '/application/models/Coupon_model.php',
    'Cron_Controller' => $baseDir . '/application/core/MY_Controller.php',
    'Customer_address_model' => $baseDir . '/application/models/Customer_address_model.php',
    'Customer_group_model' => $baseDir . '/application/models/Customer_group_model.php',
    'Customer_model' => $baseDir . '/application/models/Customer_model.php',
    'Dashboard_model' => $baseDir . '/application/models/Dashboard_model.php',
    'Download_model' => $baseDir . '/application/models/Download_model.php',
    'Email_model' => $baseDir . '/application/models/Email_model.php',
    'Email_template_model' => $baseDir . '/application/models/Email_template_model.php',
    'Faq_model' => $baseDir . '/application/models/Faq_model.php',
    'Flash_sale_model' => $baseDir . '/application/models/Flash_sale_model.php',
    'Frontend_Controller' => $baseDir . '/application/core/MY_Controller.php',
    'Import_model' => $baseDir . '/application/models/Import_model.php',
    'Inventory_model' => $baseDir . '/application/models/Inventory_model.php',
    'Jwt' => $baseDir . '/application/libraries/Jwt.php',
    'Landing_model' => $baseDir . '/application/models/Landing_model.php',
    'Language_model' => $baseDir . '/application/models/Language_model.php',
    'Login_history_model' => $baseDir . '/application/models/Login_history_model.php',
    ...
    'MY_Log' => $baseDir . '/application/core/MY_Log.php',
    'MY_Migration' => $baseDir . '/application/libraries/MY_Migration.php',
    'MY_Model' => $baseDir . '/application/core/MY_Model.php',
    'MY_Security' => $baseDir . '/application/core/MY_Security.php',
    'Migration_model' => $baseDir . '/application/models/Migration_model.php',
    'Mock_gateway' => $baseDir . '/application/libraries/Payment_gateways.php',
    'Module_model' => $baseDir . '/application/models/Module_model.php',
    'Newsletter_model' => $baseDir . '/application/models/Newsletter_model.php',
    'Notification_model' => $baseDir . '/application/models/Notification_model.php',
    'Order_model' => $baseDir . '/application/models/Order_model.php',
    ...
    'Password_history_model' => $baseDir . '/application/models/Password_history_model.php',
    'Payment_gateway' => $baseDir . '/application/libraries/Payment_gateways.php',
    ...
    'Product_attribute_value_model' => $baseDir . '/application/models/Product_attribute_value_model.php',
    'Product_model' => $baseDir . '/application/models/Product_model.php',
    'Pusher_lib' => $baseDir . '/application/libraries/Pusher_lib.php',
    'Queue' => $baseDir . '/application/libraries/Queue.php',
    'Queue_model' => $baseDir . '/application/models/Queue_model.php',
    'Recaptcha' => $baseDir . '/application/libraries/Recaptcha.php',
    'Redis_lib' => $baseDir . '/application/libraries/Redis_lib.php',
    'Report_model' => $baseDir . '/application/models/Report_model.php',
    'Return_model' => $baseDir . '/application/models/Return_model.php',
    'Review_model' => $baseDir . '/application/models/Review_model.php',
    'Role_model' => $baseDir . '/application/models/Role_model.php',
    'Sales_model' => $baseDir . '/application/models/Sales_model.php',
    ...
    'Seeder' => $baseDir . '/application/core/Seeder.php',
    'Settings_model' => $baseDir . '/application/models/Settings_model.php',
    'Shipping_model' => $baseDir . '/application/models/Shipping_model.php',
    'Sms_model' => $baseDir . '/application/models/Sms_model.php',
    'Sslcommerz_gateway' => $baseDir . '/application/libraries/Payment_gateways.php',
    'Tax_model' => $baseDir . '/application/models/Tax_model.php',
    ...
    'Totp' => $baseDir . '/application/libraries/Totp.php',
    'User_2fa_model' => $baseDir . '/application/models/User_2fa_model.php',
    'User_model' => $baseDir . '/application/models/User_model.php',
    'Wishlist_model' => $baseDir . '/application/models/Wishlist_model.php',
);
