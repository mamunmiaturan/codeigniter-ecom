(function(j) {
    ...
    m.ext.buttons.copyHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.copy", "<i class='far fa-copy'></i>")
        },
    ...
    m.ext.buttons.csvHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.csv", "<i class='far fa-file-alt'></i>")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            a = G(c, b).str;
    ...
    m.ext.buttons.excelHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.excel", "<i class='far fa-file-excel'></i>")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var e = this,
    ...
    m.ext.buttons.pdfHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.pdf", "<i class='far fa-file-pdf'></i>")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var e = this,
