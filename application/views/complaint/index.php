	...
	<div class="col-md-12">
		<section class="panel">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fas fa-exclamation-circle"></i> <?php echo translate('complaints') ?: 'Complaints'; ?></h2>
			</header>
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-condensed" cellspacing="0" width="100%" id="complaint-table">
						<thead>
							<tr>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#complaint-table').DataTable({
			...
			"columnDefs": [ { "targets": [0, 3, 4, 6], "orderable": false }, { "targets": [0, 3, 4, 6], "className": "text-center" } ],
			"ajax": {
				"url": "<?php echo base_url('complaint/get_complaints_server_side'); ?>",
				"type": "POST",
