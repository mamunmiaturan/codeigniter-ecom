<!-- Compiled Static Sidebar for superman.php -->
        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <!-- Customers Section -->
                    <?php $is_active = in_array($sub_page, ['customer_group/index', 'customer_group/form', 'customer/index']) || $main_menu == 'customers'; ?>
                    <li class="nav-parent <?php if ($is_active) echo 'nav-expanded nav-active'; ?>">
                        <a href="javascript:void(0);">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li class="<?php if ($sub_page == 'customer/index') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('customer'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('customer_list') ?: 'Customer List'; ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <!-- Payment Section -->
                    <?php $is_active = in_array($sub_page, ['payment/settings', 'payment/transactions']) || $main_menu == 'payment'; ?>
                    <li class="nav-parent <?php if ($is_active) echo 'nav-expanded nav-active'; ?>">
                        <a href="javascript:void(0);">
                            <i class="fas fa-credit-card"></i>
                            <span><?php echo translate('payment') ?: 'Payment'; ?></span>
                        </a>
                        <ul class="nav nav-children">
                            <li class="<?php if ($sub_page == 'payment/settings') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('payment-settings'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('payment_methods') ?: 'Payment Methods'; ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'payment/transactions') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('payment-settings/transactions'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('transactions') ?: 'Transactions'; ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <!-- Shipping Section -->
                    <?php $is_active = in_array($sub_page, ['shipping/methods', 'shipping/method_form', 'shipping/zones', 'shipping/zone_form']) || $main_menu == 'shipping'; ?>
                    <li class="nav-parent <?php if ($is_active) echo 'nav-expanded nav-active'; ?>">
                        <a href="javascript:void(0);">
                            <i class="fas fa-truck"></i>
                            <span><?php echo translate('shipping') ?: 'Shipping'; ?></span>
                        </a>
                        <ul class="nav nav-children">
                            <li class="<?php if ($sub_page == 'shipping/methods' || $sub_page == 'shipping/method_form') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('shipping/methods'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('shipping_methods') ?: 'Shipping Methods'; ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'shipping/zones' || $sub_page == 'shipping/zone_form') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('shipping/zones'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('shipping_zones') ?: 'Shipping Zones'; ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <!-- Support Section -->
                    <?php $is_active = in_array($sub_page, ['complaint/index', 'complaint/view', 'contact/index', 'contact/view', 'ticket/index', 'ticket/view']) || $main_menu == 'support'; ?>
                    <li class="nav-parent <?php if ($is_active) echo 'nav-expanded nav-active'; ?>">
                        <a href="javascript:void(0);">
                        ...
                        <ul class="nav nav-children">
                            <li class="<?php if ($sub_page == 'complaint/index' || $sub_page == 'complaint/view') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('complaint'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('complaints') ?: 'Complaints'; ?></span>
                                </a>
                            </li>
                            ...
                            <li class="<?php if ($sub_page == 'ticket/index' || $sub_page == 'ticket/view') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('ticket'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('tickets') ?: 'Tickets'; ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <!-- Tax Section -->
                    <?php $is_active = in_array($sub_page, ['tax/categories', 'tax/category_form', 'tax/rates', 'tax/rate_form']) || $main_menu == 'tax'; ?>
                    <li class="nav-parent <?php if ($is_active) echo 'nav-expanded nav-active'; ?>">
                        <a href="javascript:void(0);">
                            <i class="fas fa-percent"></i>
                            <span><?php echo translate('tax') ?: 'Tax'; ?></span>
                        </a>
                        <ul class="nav nav-children">
                            <li class="<?php if ($sub_page == 'tax/categories' || $sub_page == 'tax/category_form') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('tax/categories'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('tax_categories') ?: 'Tax Categories'; ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'tax/rates' || $sub_page == 'tax/rate_form') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('tax/rates'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?php echo translate('tax_rates') ?: 'Tax Rates'; ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
