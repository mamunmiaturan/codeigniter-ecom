	...
	<header class="panel-heading">
		<div class="panel-actions">
			<?php if (get_permission('blog', 'is_add')): ?>
				<a href="<?php echo base_url('blog/create'); ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i> <?php echo translate('add_post') ?: 'Add Post'; ?></a>
			<?php endif; ?>
		</div>
		<h2 class="panel-title"><i class="fas fa-blog"></i> <?php echo translate('blog') ?: 'Blog'; ?></h2>
	</header>
	<div class="panel-body">
				<table class="table table-bordered table-hover table-condensed" cellspacing="0" width="100%" id="blog-table">
			<thead>
				<tr>
					...
					<th><?php echo translate('published') ?: 'Published'; ?></th>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		var table = $('#blog-table').DataTable({
			...
			"order": [[4, "desc"]], "pageLength": 25, "autoWidth": false,
			...
			"ajax": {
				"url": "<?php echo base_url('blog/get_blogs_server_side'); ?>", "type": "POST",
		...
		$(document).on('click', '.btn-status-toggle', function () {
			var btn = $(this);
			$.ajax({ type: 'POST', url: "<?php echo base_url('blog/status'); ?>", data: { id: btn.data('id') }, dataType: 'json',
